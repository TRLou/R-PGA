...
def main():
	...
	# HPCM-TAR: targeted attack by default (can still override via args if set elsewhere)
	if not hasattr(args, "attack_mode") or not getattr(args, "attack_mode"):
		args.attack_mode = "tar"
