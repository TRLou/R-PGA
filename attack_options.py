...
def get_attack_args():
    ...
    parser.add_argument('--perturb_albedo', default=True, action='store_true', help='随机初始化albedo')
    ...
    parser.add_argument('--use_lr_scheduler', default=True, action='store_true', help="Enable learning rate scheduler for SGD optimizer.")
    ...
    parser.add_argument('--enable_min_max', default=True, action='store_true', help='Enable Min-Max adversarial training for envlight.')
    ...
    # --- SGLD Settings for Max Phase ---
    parser.add_argument('--use_sgld', default=False, action='store_true', help='Use SGLD for envlight updates in the max phase instead of Adam.')
    ...
    parser.add_argument('--use_replay_buffer', default=True, action='store_true', help='Enable replay buffer for envlight states in max phase.')
    parser.add_argument('--buffer_size', type=int, default=100, help='Max number of envlight states to keep in the replay buffer.')
